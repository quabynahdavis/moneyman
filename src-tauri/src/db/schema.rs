...
pub const INSERT_SEED_DATA: &[&str] = &[
    ...
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (1, NULL, 'ROOT', NULL, 'Root Account', 'USD', 1)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (2, 1, 'ASSET', '1000', 'Assets', 'USD', 1)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (3, 2, 'BANK', '1100', 'Checking Account', 'USD', 0)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (4, 2, 'BANK', '1200', 'Savings Account', 'USD', 0)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (5, 2, 'CASH', '1300', 'Cash on Hand', 'USD', 0)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (6, 1, 'LIABILITY', '2000', 'Liabilities', 'USD', 1)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (7, 6, 'CREDIT_CARD', '2100', 'Credit Card', 'USD', 0)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (8, 1, 'EQUITY', '3000', 'Equity', 'USD', 1)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (9, 8, 'EQUITY', '3100', 'Opening Balances', 'USD', 0)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (10, 1, 'INCOME', '4000', 'Income', 'USD', 1)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (11, 10, 'INCOME', '4100', 'Employment Income', 'USD', 0)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (12, 1, 'EXPENSE', '5000', 'Expenses', 'USD', 1)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (13, 12, 'EXPENSE', '5100', 'Housing', 'USD', 0)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (14, 12, 'EXPENSE', '5200', 'Food & Dining', 'USD', 0)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (15, 12, 'EXPENSE', '5300', 'Transportation', 'USD', 0)",
    "INSERT OR IGNORE INTO accounts (id, parent_id, account_type, code, name, currency_code, placeholder) VALUES (16, 12, 'EXPENSE', '5400', 'Utilities', 'USD', 0)",
];
